...
- Lots of everyone's time will be spent interacting with solid, legacy code.
  Comments are the most important thing. I believe in over-commenting your code.
  So many more people will read your code than write it with you, so it's best
  to make that a habit both so you can express your understanding and help others.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

- As opposed to having several virtual machines that require cumbersome effort to
  enter, exit and setup, containers allow one host machine to run several virtual
  environments that allow ease of transfer among colleagues who need each other's
  code, work, packages, etc. with whatever they'r working on.
